...
node_keys = {
    name: {
        "publicKey": os.getenv(f"PY_MAINNET_NEUROWEB_{name.replace(' ', '').upper()}_PUBLIC_KEY"),
        "privateKey": os.getenv(f"PY_MAINNET_NEUROWEB_{name.replace(' ', '').upper()}_PRIVATE_KEY"),
    }
...
def run_test_for_node(node, index):
    ...
    for i in range(10):
        ...
        try:
            ...
            ual = "did:dkg:otp:2043/0x8f678eb0e57ee8a109b295710e23076fa3a443fe/3936946"
